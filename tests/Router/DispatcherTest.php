...
use All\Router\Collector;
use All\Router\Dispatcher;
use All\Router\Generator;
use All\Router\Interfaces\CollectorInterface;
use All\Router\Parser;
use PHPUnit\Framework\TestCase;

/**
 * @group DispatcherTest
 */
class DispatcherTest extends TestCase
{
    ...
    public function testDuplicateVariableNameError(): void
    {
        ...
        simpleDispatcher(static function (CollectorInterface $r): void {
    ...
    public function provideFoundDispatchCases(): array
    {
        ...
        $callback = static function (CollectorInterface $r): void {
...
function simpleDispatcher(callable $routeDefinitionCallback, array $options = []): Dispatcher
{
    ...
    assert($routeCollector instanceof Collector);
